...
class Story_app(tk.Tk):
    def __init__(self):
        ...
        self.text_widget = tk.Text(self, height=20,  wrap="word")
        ...
        self.search_button = tk.Button(self, text="Yes", command=self.yes)
        self.search_button.grid(row=1, column=0, padx=10, pady=10, sticky="w")

        self.search_button = tk.Button(self, text="No", command=self.no)
        self.search_button.grid(row=1, column=1, padx=10, pady=10, sticky="w")

        self.search_button = tk.Button(self, text="New Story", command=self.new_story)
